...
function createBaseMsgDonateAllVestingTokens(): MsgDonateAllVestingTokens {
  return {
    fromAddress: ""
  };
}
...
export const MsgDonateAllVestingTokens = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgDonateAllVestingTokens {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgDonateAllVestingTokens();
...
function createBaseMsgDonateAllVestingTokensResponse(): MsgDonateAllVestingTokensResponse {
  return {};
}
...
export const MsgDonateAllVestingTokensResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgDonateAllVestingTokensResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgDonateAllVestingTokensResponse();
