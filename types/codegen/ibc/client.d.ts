...
export declare const ibcAminoConverters: {
    ...
    "/ibc.applications.fee.v1.MsgRegisterCounterpartyAddress": {
        aminoType: string;
        toAmino: ({ address, counterpartyAddress, channelId }: import("./applications/fee/v1/tx").MsgRegisterCounterpartyAddress) => {
            address: string;
            counterparty_address: string;
            channel_id: string;
        };
        fromAmino: ({ address, counterparty_address, channel_id }: {
            address: string;
            counterparty_address: string;
            channel_id: string;
        }) => import("./applications/fee/v1/tx").MsgRegisterCounterpartyAddress;
    };
    "/ibc.applications.fee.v1.MsgPayPacketFee": {
        aminoType: string;
        toAmino: ({ fee, sourcePortId, sourceChannelId, signer, relayers }: import("./applications/fee/v1/tx").MsgPayPacketFee) => {
            fee: {
                recv_fee: {
                    denom: string;
                    amount: string;
        ...
        fromAmino: ({ fee, source_port_id, source_channel_id, signer, relayers }: {
            ...
            signer: string;
            relayers: string[];
        }) => import("./applications/fee/v1/tx").MsgPayPacketFee;
    };
    "/ibc.applications.fee.v1.MsgPayPacketFeeAsync": {
        aminoType: string;
        toAmino: ({ packetId, packetFee }: import("./applications/fee/v1/tx").MsgPayPacketFeeAsync) => {
            packet_id: {
                port_id: string;
                channel_id: string;
                sequence: string;
        ...
        }) => import("./applications/fee/v1/tx").MsgPayPacketFeeAsync;
    };
};
