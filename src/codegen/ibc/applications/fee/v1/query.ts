...
export interface QueryCounterpartyAddressRequestSDKType {
  /** unique channel identifier */
  channel_id: string;
  /** the relayer address to which the counterparty is registered */
...
export interface QueryCounterpartyAddressResponseSDKType {
  /** the counterparty address used to compensate forward relaying */
...
function createBaseQueryCounterpartyAddressRequest(): QueryCounterpartyAddressRequest {
  return {
    channelId: "",
    relayerAddress: ""
  };
...
export const QueryCounterpartyAddressRequest = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryCounterpartyAddressRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryCounterpartyAddressRequest();
...
function createBaseQueryCounterpartyAddressResponse(): QueryCounterpartyAddressResponse {
  return {
    counterpartyAddress: ""
  };
}
...
export const QueryCounterpartyAddressResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryCounterpartyAddressResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryCounterpartyAddressResponse();
