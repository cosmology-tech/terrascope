...
export class MsgClientImpl implements Msg {
  ...
  registerCounterpartyAddress(request: MsgRegisterCounterpartyAddress): Promise<MsgRegisterCounterpartyAddressResponse> {
    const data = MsgRegisterCounterpartyAddress.encode(request).finish();
    const promise = this.rpc.request("ibc.applications.fee.v1.Msg", "RegisterCounterpartyAddress", data);
    return promise.then(data => MsgRegisterCounterpartyAddressResponse.decode(new _m0.Reader(data)));
  }
