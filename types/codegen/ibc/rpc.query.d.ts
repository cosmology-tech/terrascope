        ...
        applications: {
            fee: {
                v1: {
                    ...
                    counterpartyAddress(request: import("./applications/fee/v1/query").QueryCounterpartyAddressRequest): Promise<import("./applications/fee/v1/query").QueryCounterpartyAddressResponse>;
